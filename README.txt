...
- Claiming a capital borrows that nation's claims. While you hold a
  claim on the original capital of a dormant nation, you can use the
  claims of that nation. Holding the region is not required, and would
  not be enough on its own: a region you own is not in your own claim
  list. Your claim on the capital must not be hostile. You lose the
  borrowed claims when that claim goes away or becomes hostile. A claim that the other nation held as hostile stays
